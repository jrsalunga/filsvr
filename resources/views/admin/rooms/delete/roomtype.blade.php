...
<div class="row row2" style="color:rgb(144, 58, 58);text-align:center">
	...
	<h1 class="text-center" style="color:rgb(144, 58, 58)"> Are you sure you want to delete this room type? </h1>
	<BR><BR>
	<form method="POST" action="{{ url('admin/rooms/type/'.$selectedroomtype->id) }}">
	<input type="hidden" name="_method" value="DELETE">
	{{ csrf_field() }}
		<a href="/admin/rooms/type/{{ $selectedroomtype->slug }}" class="btn btn-danger btn-lg"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> NO</a>
